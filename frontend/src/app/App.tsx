...
type Page='categories'|'suppliers'|'ingredients'|'nutrition'|'dishes'|'recipe'|'production-profile'|'menus'|'menu-editor'|'postpartum'|'postpartum-restrictions'|'postpartum-menu-source'|'requirements'|'snapshots'|'purchases'|'kitchen'|'users'|'audit'
const businessGroups=[
  ...
  {label:'月子餐',items:[['postpartum','個案管理'],['postpartum-restrictions','禁忌群組管理'],['postpartum-menu-source','菜單來源／週期']]},
...
function NavIcon({page}:{page:NavPage}){
  const paths:Record<NavPage,string>={
    ...
    nutrition:'M12 2a7 7 0 0 0-7 7c0 5 7 13 7 13s7-8 7-13a7 7 0 0 0-7-7Zm-3 8h6m-3-3v6',
    ...
    postpartum:'M12 21s-7-4.4-7-10a4 4 0 0 1 7-2.6A4 4 0 0 1 19 11c0 5.6-7 10-7 10Z',
