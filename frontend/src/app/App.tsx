...
export function App() {
  ...
  const [page, setPage] = useState<'categories' | 'suppliers' | 'ingredients' | 'dishes' | 'recipe' | 'menus' | 'menu-editor'>('categories')
