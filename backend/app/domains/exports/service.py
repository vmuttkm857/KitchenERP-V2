...
from app.domains.exports.menu_exports import menu_full_pdf,menu_full_workbook,menu_grid_pdf,menu_grid_workbook,menu_pretty_pdf,menu_pretty_workbook
...
class ExportService:
    ...
    def menu(self,menu_id,layout,format,variant="single"):
